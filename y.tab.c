...
{
       0,    59,    59,    65,    66,    69,    71,    72,    77,    78,
      81,    83,    92,   107,   116,   135,   147,   164,   174,   196,
     204,   212,   221,   224,   226,   228,   230,   232,   234,   241,
     263,   267,   271
};
#endif
...
#line 59 "expl.y" /* yacc.c:1646  */
    {
		evaluate((yyvsp[-2].tnode_ptr));	// evaluate statements
		exit(1);
	}
